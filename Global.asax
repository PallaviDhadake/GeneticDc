...
<script runat="server">
    ...
    void RegisterRoutes(System.Web.Routing.RouteCollection routes)
    {
        ...
        routes.MapPageRoute("about-route", "about-us", "~/about-us.aspx");
        ...
        routes.MapPageRoute("disessesegment-route", "disease-segment", "~/disease-segment.aspx");

        routes.MapPageRoute("default-route", "default", "~/default.aspx");
